    ...
    return (
        ...
        >
            ...
            <div className="mt-4 flex items-center justify-between text-xs text-slate-500">
                ...
                {issue.mlConfidence && (
                    <div className="flex items-center gap-1 bg-slate-100/50 px-2 py-1 rounded-md">
                        <AlertCircle className="w-3 h-3 text-indigo-400" />
                        <span className="text-indigo-300">AI Match: {(issue.mlConfidence * 100).toFixed(0)}%</span>
                    </div>
                )}
            </div>
        </motion.div>
